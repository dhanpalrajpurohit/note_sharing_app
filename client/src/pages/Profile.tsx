...
export default function Profile() {
    ...
    return (
        <div className="w-full mx-auto max-w-screen-xl px-4 place-items-center">
            <Typography className='mx-1 my-2 p-2 rounded' variant="h4" color='gray'>Profile</Typography>
            <Card className="w-full max-w-full 50vh">
                        ...
                        <div className="w-full">
                            <form className="mb-2 w-80 max-w-screen-lg sm:w-96">
                                <div className="mb-4 flex flex-col gap-6">
                                    ...
                                    <Input size="lg" label="Username" value="rajpuroitdhanpal" disabled />

                                    <Typography variant="h6" color="blue-gray" className="-mb-3">
                                        First Name
                                    </Typography>
                                    <Input size="lg" label="First Name" value="Dhanpal Singh" disabled />

                                    <Typography variant="h6" color="blue-gray" className="-mb-3">
                                        Last Name
                                    </Typography>
                                    <Input size="lg" label="Last Name" value="Rajpurohit" disabled />

                                    <Typography variant="h6" color="blue-gray" className="-mb-3">
                                        Email Address
                                    </Typography>
                                    <Input size="lg" label="Email" value="rajpurohitdhanpal@gmail.com" disabled />
                                </div>
                                <div className="flex w-max gap-4">
                                    <Button color="blue" size="sm">
                                        Save Changes
                                    </Button>
                                    <Button variant="text" size="sm" className="flex items-center gap-2" onClick={() => setPasswordModalOpen(!passwordModalOpen)}>
                                        Reset Password
                                        <svg
            ...
            {passwordModalOpen && <ResetPasswordModal show={passwordModalOpen} />}

            {/* <div className=" flex flex-row container mx-auto px-4 mt-5 p-6 shadow-md rounded-xl dark:bg-gray-900 dark:text-gray-100">
                ...
                <div className="space-y-4 text-center divide-y divide-gray-700">
                    <div className="my-2 space-y-1">
                        <h2 className="text-xl font-semibold sm:text-2xl">Dhanpal Singh Rajpurohit</h2>
